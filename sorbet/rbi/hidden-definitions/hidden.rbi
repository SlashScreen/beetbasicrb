...
class BeetBasic::Number
  def value(); end

  def value=(value); end
end

class BeetBasic::Prototype
  def arg_names(); end
...
module Filigree::Commands
  HELP_COMMAND = ::T.let(nil, ::T.untyped)
end

module Filigree::Configuration
  HELP_OPTION = ::T.let(nil, ::T.untyped)
end
...
module RLTK
  LLVM_TARGET_VERSION = ::T.let(nil, ::T.untyped)
  VERSION = ::T.let(nil, ::T.untyped)
end
